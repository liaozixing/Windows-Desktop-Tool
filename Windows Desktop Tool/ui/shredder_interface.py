...
from PyQt5.QtWidgets import QAction, QApplication, QHBoxLayout, QMenu, QTableWidgetItem, QVBoxLayout, QWidget
...
from modules.file_shredder import ShredderWorker, ValidationWorker, is_system_path
...
class ShredderInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.file_list.horizontalHeader().setSectionResizeMode(0, self.file_list.horizontalHeader().Stretch)
        self.file_list.horizontalHeader().setSectionResizeMode(1, self.file_list.horizontalHeader().Fixed)
        self.file_list.horizontalHeader().setSectionResizeMode(2, self.file_list.horizontalHeader().Fixed)
    ...
    def add_paths(self, paths):
        ...
        for path in paths:
            ...
            elided_path = fm.elidedText(path, Qt.ElideMiddle, 400)
